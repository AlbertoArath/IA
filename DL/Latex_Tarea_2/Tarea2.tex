...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{relu.jpg}  % Cambia el nombre del archivo y su ruta según sea necesario
\end{figure}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{sigmoide.jpg}  % Cambia el nombre del archivo y su ruta según sea necesario
  \end{figure}
  \item Calcular el producto $W^T X$ y graficarlo en GeoGebra 3D.
  ...
  \begin{enumerate}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.5\textwidth]{linear.jpg}  % Cambia el nombre del archivo y su ruta según sea necesario
    \end{figure}
    \item Calcular el producto $W^T X$ y graficarlo en GeoGebra 3D.
